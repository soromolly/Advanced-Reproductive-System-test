...
export const TRANSLATIONS = {
    ru: {
        ...
        toastMedievalPositive: '🌿 Знахарка подтвердила: под сердцем зародилась новая жизнь! Срок: ',
        toastMedievalNegative: '🌿 Травница не обнаружила признаков дитя. Беременности нет, задержка цикла.',
    ...
    en: {
        ...
        toastMedievalPositive: '🌿 The herbalist confirmed: a new life is growing in the womb! Term: ',
        toastMedievalNegative: '🌿 The herbalist found no signs of a child. No pregnancy, merely a cycle delay.',
